...
for filename, t in THEMES.items():
    ...
    info = [
        ...
        info_line(70, "Uptime", "10 years, 0 months, 15 days", "age_data_dots", "age_data"),
        info_line(90, "Host", "Perth, Western Australia"),
        info_line(110, "Kernel", "Software Engineer"),
        info_line(130, "IDE", "VS Code, Claude Code"),
        blank_line(150),
        info_line(170, "Languages.Programming", "JavaScript, TypeScript, Python"),
        info_line(190, "Languages.Computer", "HTML, CSS, SQL, JSON, YAML"),
        ...
        info_line(410, "Instagram", "pamp178"),
